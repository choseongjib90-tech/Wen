...
export default function Contact(){
  ...
  return <main>
    ...
    <footer className="contact-footer"><div className="legal wrap"><span>상호 조세탁연구소　|　대표자: 조성집　|　사업자등록번호: 877-31-01664</span><span>ⓒ GK클린. All rights reserved.</span></div></footer><div className="floating"><a href="https://blog.naver.com/house_90" target="_blank" rel="noopener noreferrer" aria-label="조세탁연구소 네이버 블로그">N</a><a href="tel:01035550517">☎　010-3555-0517</a></div>
  </main>
}
