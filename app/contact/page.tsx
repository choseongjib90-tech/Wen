...
export default function Contact(){
  ...
  return <main>
    ...
    </form><aside className="contact-aside"><div><small>바로 연락하기</small><a href="tel:01035550517">☎　010-3555-0517</a><p>⌖　경기도 용인시 처인구 모현읍 외개일로 37<br/>　　(직영 세탁 공장)</p><span>사업자등록번호 877-31-01664</span></div><div><small>먼저 둘러보기</small><a href="https://blog.naver.com/house_90" target="_blank" rel="noopener noreferrer">· 공식 블로그 세탁 기록</a></div><p>지점이 여러 곳이거나 <strong>요양원 · 기업 · 연수원처럼 대량</strong>이신 경우, 문의 내용에 지점 수와 품목을 함께 적어주시면 한 번에 안내해 드립니다.</p></aside></section>
    <footer className="contact-footer"><div className="legal wrap"><span>상호 조세탁연구소　|　대표자: 조성집　|　사업자등록번호: 877-31-01664</span><span>ⓒ 조세탁연구소. All rights reserved.</span></div></footer><div className="floating"><a href="https://blog.naver.com/house_90" target="_blank" rel="noopener noreferrer" aria-label="조세탁연구소 네이버 블로그">N</a><a href="https://www.youtube.com/channel/UCeeyW2Jew63mU9BHacpsu4A" target="_blank" rel="noopener noreferrer" aria-label="조세탁연구소 유튜브" style={{order:-1,width:'44px',height:'44px',borderRadius:'50%'}}><svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M23.5 6.2a3 3 0 0 0-2.1-2.1C19.5 3.6 12 3.6 12 3.6s-7.5 0-9.4.5A3 3 0 0 0 .5 6.2 31 31 0 0 0 0 12a31 31 0 0 0 .5 5.8 3 3 0 0 0 2.1 2.1c1.9.5 9.4.5 9.4.5s7.5 0 9.4-.5a3 3 0 0 0 2.1-2.1A31 31 0 0 0 24 12a31 31 0 0 0-.5-5.8ZM9.6 15.6V8.4L15.8 12l-6.2 3.6Z"/></svg></a><a href="tel:01035550517">☎　010-3555-0517</a></div>
  </main>
}
