...
export default function Contact(){
  ...
  return <main>
    ...
    </form><aside className="contact-aside"><div><small>바로 연락하기</small><a href="tel:01035550517">☎　010-3555-0517</a><p>⌖　경기도 시흥시 미산로 94-1<br/>　　(직영 세탁 공장)</p><span>사업자등록번호 374-86-02602</span></div><div><small>먼저 둘러보기</small><a href="#">· 공식 블로그 세탁 기록</a></div><p>지점이 여러 곳이거나 <strong>요양원 · 기업 · 연수원처럼 대량</strong>이신 경우, 문의 내용에 지점 수와 품목을 함께 적어주시면 한 번에 안내해 드립니다.</p></aside></section>
    <footer className="contact-footer"><div className="legal wrap"><span>상호 주식회사 지케이클린　|　대표자: 조성준　|　사업자등록번호: 374-86-02602</span><span>ⓒ GK클린. All rights reserved.</span></div></footer><div className="floating"><a href="#">N</a><a href="tel:01035550517">☎　010-3555-0517</a></div>
  </main>
}
