...
export default function Home() {
  return <main>
    <header className="site-header">
      ...
      <a className="nav-cta" href={`${BASE}/contact/`}>견적 문의</a><a className="phone" href="tel:16661778">☎ <strong>1666-1778</strong></a>
    </header>
    ...
    <section id="contact" className="cta" style={{backgroundImage:`url('${BASE}/assets/hero.webp')`}}><div className="hero-shade"/><div><h2>미용실 수건 세탁, 한 번 맡겨보세요</h2><p>매장에 방문해 세탁물을 직접 보고 견적을 드립니다. 샘플링도 함께 도와드립니다.</p><a className="blue-btn" href="tel:16661778">☎　1666-1778</a><a className="ghost-btn" href={`${BASE}/contact/`}>견적 문의하기</a></div></section>

    <footer><div className="footer-grid wrap"><div><div className="footer-logo"><span className="logo-mark">GK</span><strong>GK클린</strong></div><b>BUSINESS LAUNDRY SERVICE</b><p>미용실 · 병원 · 피부과 · 에스테틱 · 요양원 · 기업의 수건과 단체 세탁물을 수거해 세탁하고 배달해 드립니다. 다른 사업장 세탁물과 섞지 않는 업체별 단독세탁, 고온스팀 살균, 100% 수작업 검수를 지킵니다.</p><a href="#">BLOG</a></div><div><small>바로가기</small>{['GK클린 소개','업종별 수건세탁','품목 · 대량','세탁 공정','가격 안내','세탁 사례','견적 문의'].map(x=><a href={x==='견적 문의'?`${BASE}/contact/`:'#'} key={x}>{x}</a>)}</div><div><small>상담 · 견적</small><h3>1666-1778</h3><a className="footer-btn" href={`${BASE}/contact/`}>견적 문의하기</a><p>대표자: 조성준</p><p>경기도 시흥시 미산로 94-1 (직영 세탁 공장)</p></div></div><div className="legal wrap"><span>상호 주식회사 지케이클린　|　대표자: 조성준　|　사업자등록번호: 374-86-02602</span><span>ⓒ GK클린. All rights reserved.</span></div></footer>
