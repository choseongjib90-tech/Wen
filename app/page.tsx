...
export default function Home() {
  return <main>
    ...
    <footer><div className="footer-grid wrap"><div><div className="footer-logo"><span className="logo-mark">GK</span><strong>GK클린</strong></div><b>BUSINESS LAUNDRY SERVICE</b><p>미용실 · 병원 · 피부과 · 에스테틱 · 요양원 · 기업의 수건과 단체 세탁물을 수거해 세탁하고 배달해 드립니다. 다른 사업장 세탁물과 섞지 않는 업체별 단독세탁, 고온스팀 살균, 100% 수작업 검수를 지킵니다.</p><a href="#">BLOG</a></div><div><small>바로가기</small>{['업종별 수건세탁','품목 · 대량','세탁 공정','가격 안내','세탁 사례','견적 문의'].map(x=><a href={x==='견적 문의'?`${BASE}/contact/`:'#'} key={x}>{x}</a>)}</div><div><small>상담 · 견적</small><h3>010-3555-0517</h3><a className="footer-btn" href={`${BASE}/contact/`}>견적 문의하기</a><p>대표자: 조성집</p><p>경기도 용인시 처인구 모현읍 외개일로 37 (직영 세탁 공장)</p></div></div><div className="legal wrap"><span>상호 조세탁연구소　|　대표자: 조성집　|　사업자등록번호: 374-86-02602</span><span>ⓒ GK클린. All rights reserved.</span></div></footer>
